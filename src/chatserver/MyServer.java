...
class MyClient implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent ev)
    {
        ...
        if(temp == sendButton)
        {
            if(s == null)
            {
                JOptionPane.showMessageDialog(chatWindow,"You are not Logged in. Please Log in First to Chat"); 
                return;
            }
            try
            {
        ...
        if(temp == loginButton)
        {
            ...
            //String password = JOptionPane.showInputDialog(chatWindow,"Enter Your Password: ");
            if(uname != null)
                clientChat(uname); 
        }
